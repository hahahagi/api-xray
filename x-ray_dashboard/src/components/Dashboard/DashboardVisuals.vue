          ...
          <div class="oee-components">
            <div class="oee-component">
              <div class="component-header">
                ...
                <span class="component-value">{{ machineStore.oeeData.availability }}%</span>
              </div>
              <div class="progress">
                <div 
                  class="progress-bar" 
              ...
              <div class="component-formula">
                ({{ machineStore.dashboardData.jam_operasi }}h / {{ machineStore.dashboardData.jam_terencana }}h) × 100
              </div>
            </div>
            ...
            <div class="oee-component">
              <div class="component-header">
                ...
                <span class="component-value">{{ machineStore.oeeData.performance }}%</span>
              </div>
              <div class="progress">
                <div 
              ...
              <div class="component-formula">
                ({{ machineStore.dashboardData.aktual_produksi }} / {{ machineStore.dashboardData.target_produksi }}) × 100
              </div>
            </div>
            ...
            <div class="oee-component">
              <div class="component-header">
                ...
                <span class="component-value">{{ machineStore.oeeData.quality }}%</span>
              </div>
              <div class="progress">
                <div 
              ...
              <div class="component-formula">
                ({{ machineStore.dashboardData.ban_ok }} / {{ totalProducts }}) × 100
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="production-summary mt-3">
              ...
              <div class="summary-item">
                ...
                <div class="summary-value">{{ machineStore.dashboardData.aktual_produksi }} tires</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="refresh-status mt-4">
      <div class="alert alert-light border">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-end">
            <div class="last-update">Last: {{ machineStore.dashboardData.lastUpdated || 'Never' }}</div>
...
const okPercentage = computed(() => {
  ...
  return ((machineStore.dashboardData.ban_ok / totalProducts.value) * 100).toFixed(1)
})

const ngPercentage = computed(() => {
  if (totalProducts.value === 0) return 0
  return ((machineStore.dashboardData.ban_ng / totalProducts.value) * 100).toFixed(1)
})
...
function initCharts() {
  ...
  if (pieChart.value) {
    ...
    const pieChartInstance = new window.Chart(ctx, {
      type: 'doughnut',
      data: machineStore.pieChartData,
      options: {
        responsive: true,
    ...
    chartInstances.push(pieChartInstance)
  }
